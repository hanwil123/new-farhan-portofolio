      ...
      <main className="container relative mx-auto px-6 py-32">
        ...
        >
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3, duration: 0.5 }}
            className="bg-gradient-to-r from-teal-200 via-white to-teal-200 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-6xl my-2"
          >
            ...
            >
            Hi, I am Farhan Wildan, a passionate Fullstack Developer. I specialize in creating exceptional digital
          ...
          >
            ...
            <div className="flex gap-4 text-white">
              <Button variant="ghost" size="icon" asChild>
                <a href="https://github.com/hanwil123" target="_blank" rel="noopener noreferrer">
                  <GithubIcon className="h-5 w-5" />
                </a>
              </Button>
              <Button variant="ghost" size="icon" asChild>
                <a href="https://www.linkedin.com/in/farhan-wildan-52b490256" target="_blank" rel="noopener noreferrer">
                  <LinkedinIcon className="h-5 w-5" />
                </a>
              </Button>
              <Button variant="ghost" size="icon" asChild>
                <a href="https://www.instagram.com/wildan312" target="_blank" rel="noopener noreferrer">
